...
pacman -Sy acpi alsa-utils ansible arc-gtk-theme arc-icon-theme autocutsel bind-tools bash-completion \
    ...
    lxdm lxrandr lxterminal nano network-manager-applet networkmanager openssh p7zip parcellite \
    pavucontrol pulsemixer playerctl pulseaudio rdesktop restic ristretto rofi rsync speedcrunch sudo \
    thunar transmission-gtk ttf-bitstream-vera ttf-dejavu ttf-liberation tumbler unzip variety \
...
sudo -u nobody yay -S systemd-boot-pacman-hook numix-circle-icon-theme-git spotify mirrorlist-manager insync
