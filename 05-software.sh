...
pacman -Sy acpi alsa-utils ansible arc-gtk-theme arc-icon-theme autocutsel bind-tools bash-completion \
	...
	libsecret lxappearance lxdm lxterminal mysql nano network-manager-applet networkmanager openssh pavucontrol \
	pcmanfm playerctl pulseaudio rdesktop ristretto rofi rsync scrot seahorse speedcrunch sudo ttf-bitstream-vera \
	ttf-dejavu ttf-liberation tumbler unzip variety wget xbindkeys xclip xdg-user-dirs \
	xdg-utils xdotool xf86-input-libinput xf86-video-intel xorg xorg-xinit
